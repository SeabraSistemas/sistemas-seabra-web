/**
 * Gerador de .xlsx sem dependência, pro browser (client component). Cópia
 * fiel de src/lib/katmandu/xlsx.ts (Katmandu congelado) em pasta neutra —
 * ver src/lib/adm/xlsx.ts (server-only) pro racional completo de "por que
 * não instalar exceljs/sheetjs".
 */
