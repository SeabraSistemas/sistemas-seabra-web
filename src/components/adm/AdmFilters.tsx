...
import { formatarData, formatarInteiro, formatarNumero } from '@/lib/adm/format';
...
/**
 * O filtro em si — tipos, gramática da URL e a função que aplica — mora em
 * '@/lib/adm/facetas', módulo puro: a rota de exportação roda EXATAMENTE a mesma
 * função para o arquivo bater com a grade. Reexportado para quem já importa
 * daqui.
 */
export {
  PRESETS_PERIODO,
